...
HELP_TEXT = (
    "<b>Привет! Я МарИИя — твой AI-нутрициолог.</b>\n\n"
    "Я работаю только на основе сборника рецептов Марии Дивисенко (232 рецепта).\n\n"
    "<b>Что я умею:</b>\n"
    "Составлять для тебя рационы на день, неделю, месяц — с учётом твоих "
    "целей по КБЖУ, аллергий, предпочтений. Использую только рецепты из сборника.\n\n"
    "<b>Команды:</b>\n"
    "/start, /help — это сообщение\n"
    "/profile — показать что я о тебе знаю\n"
    "/forget — забыть диалог и собранные факты (профиль сохранится)\n"
    "/reset — полный сброс (как новый клиент)\n\n"
    "<b>Пример запроса:</b>\n"
    "<i>Составь рацион на день на 1500 ккал, БЖУ 120/50/100, "
    "не люблю курицу и рыбу, люблю сладкое</i>\n\n"
    "Или просто расскажи о своих целях — я подберу что предложить."
)
